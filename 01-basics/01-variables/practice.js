...
// Task: Create a variable using let, assign it an initial value, then reassign it.
...
// Task: Create a const variable and try to reassign it. Observe the error.
...
//      • Age
//      • Profession
// Hint: Use appropriate variable names and print all values.
...
//      • price
//      • quantity
// Hint: Calculate and print the total price.
...
// Task: Create a variable using var inside a function and try to access it outside the function.
...
// Task: Create a variable using let inside an if block and try to access it outside the block.
...
// Task: Create an object using const, then change one of its properties.
// Hint: Explain why modifying the property works even though the variable was declared with const.
