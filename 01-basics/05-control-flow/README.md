...
if...else
Comparison
Object property access 30. Practical Example: Login Check
const isLoggedIn = true;
...
38. Interview Questions
    ...
    What values can be used as conditions in JavaScript?
    What are truthy and falsy values?
    Conditional Statements
    What is the difference between if...else and else if?
    Can an if statement exist inside another if statement?
    What problems can excessive nesting cause?
    How does JavaScript evaluate an if...else if...else chain?
    ...
    Can multiple case clauses execute the same code?
    Loops
    What is a loop?
    What are the main loop types in JavaScript?
    What is the difference between for and while?
    What is the difference between while and do...while?
    Why does a do...while loop always execute at least once?
    What causes an infinite loop?
    How can you stop a loop early?
    break and continue
    What does break do?
    What does continue do?
    What is the difference between break and continue?
    Can break be used with switch?
    What happens to the remaining code in the current iteration after continue?
    for...of and for...in
    What is the difference between for...of and for...in?
    What does for...of iterate over?
    What does for...in iterate over?
    Which is generally more appropriate for iterating over array values?
    Can for...of be used with strings?
    Why should you be careful when using for...in with arrays?
    Output / Reasoning
    What is the output?
    for (let i = 0; i < 3; i++) {
    console.log(i);
...
What happens if the update expression of a loop never changes the condition?
What is the output of a switch statement when break is missing? 39. Practice
